      ...
      <div className="auth-brand">
        ...
        <div className="auth-brand-features">
          {[
            ...
            'Share your Org ID for teammates to join',
            'ADMIN manages roles via Members panel',
          ...
          {mode === 'create' && (
            <form className="auth-form" onSubmit={createForm.handleSubmit(onCreateSubmit)} noValidate>
              <div className="form-group">
                ...
                <input
                  className={`form-input${createForm.formState.errors.name ? ' is-error' : ''}`}
              ...
              <div className="form-group">
                ...
                <input
                  className={`form-input${createForm.formState.errors.org_name ? ' is-error' : ''}`}
              ...
              <div className="form-group">
                ...
                <input
                  className={`form-input${createForm.formState.errors.email ? ' is-error' : ''}`}
                  type="email"
              ...
              <div className="form-group">
                ...
                <input
                  className={`form-input${createForm.formState.errors.password ? ' is-error' : ''}`}
                  type="password"
              ...
              <div className="auth-role-hint">
                You will be assigned <strong>ADMIN</strong> role as the first member of your organisation.
              </div>
          ...
          {mode === 'join' && (
            <form className="auth-form" onSubmit={joinForm.handleSubmit(onJoinSubmit)} noValidate>
              <div className="form-group">
                <label className="form-label">Full name</label>
                <input
                  className={`form-input${joinForm.formState.errors.name ? ' is-error' : ''}`}
                  placeholder="Jane Smith"
              ...
              <div className="form-group">
                ...
                <input
                  className={`form-input${joinForm.formState.errors.org_id ? ' is-error' : ''}`}
              ...
              <div className="form-group">
                <label className="form-label">Work email</label>
                <input
                  className={`form-input${joinForm.formState.errors.email ? ' is-error' : ''}`}
                  type="email"
                  placeholder="jane@company.com"
              ...
              <div className="form-group">
                <label className="form-label">Password</label>
                <input
                  className={`form-input${joinForm.formState.errors.password ? ' is-error' : ''}`}
                  type="password"
                  placeholder="Min. 8 characters"
              ...
              <div className="auth-role-hint">
                You will join as <strong>MEMBER</strong>. Your ADMIN can promote you later.
              </div>
